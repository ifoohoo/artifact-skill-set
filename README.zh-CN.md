...
这是一个面向 Claude Code、CodeBuddy/WorkBuddy、OpenAI Codex 和 Kimi Code 的 AI IDE 插件市场。
...
- 当前收录：`artifact-chain-assistant`、`e2e-test`、`flow-architect`、`release-skill`。各平台是否可用，以表格为准。
